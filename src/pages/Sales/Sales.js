...
import Strat from "../../assets/img/strat.png";
...
const Sales =()=>{
    return(
        ...
        <PageHeader  pagename="Sales  Licenses Strategies & Advisor" pagelinkname="Services"/>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="content-wrapper">
                <h3>
                Sales  Licenses<span>Strategies & Advisor</span>
                </h3>
